...
import { BotChatUser } from '../app/AppState';
...
export const conversationsSlice = createSlice({
    ...
    reducers: {
        ...
        updateBotResponseStatus: (
            ...
            console.log('updateBotResponseStatus:', chatId, status, state);
        },
...
const updateConversation = (state: ConversationsState, chatId: string, message: IChatMessage) => {
    const requestUserFeedback = message.userId === BotChatUser.id && message.type === ChatMessageType.Message;
